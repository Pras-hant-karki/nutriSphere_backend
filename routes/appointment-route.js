...
const { createAppointment, getAllAppointments, updateAppointmentStatus, getPendingAppointments, getAcceptedAppointments, getRejectedAppointments } = require('../controllers/appointment-controller');
...
router.get('/', verifyUser, verifyAdmin, getAllAppointments);
